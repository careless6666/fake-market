...
const models: TsoaRoute.Models = {
    ...
    "BaseResponse_LoginResult_": {
        "dataType": "refObject",
        "properties": {
            "data": {"dataType":"union","subSchemas":[{"ref":"LoginResult"},{"dataType":"enum","enums":[null]}],"required":true},
    ...
    "CategoryItems": {
        "dataType": "refObject",
        "properties": {
            "items": {"dataType":"array","array":{"dataType":"refObject","ref":"CategoryItem"},"required":true},
        },
        "additionalProperties": false,
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "BaseResponse_CategoryItems_": {
        "dataType": "refObject",
        "properties": {
            "data": {"dataType":"union","subSchemas":[{"ref":"CategoryItems"},{"dataType":"enum","enums":[null]}],"required":true},
            "error": {"dataType":"union","subSchemas":[{"ref":"Error"},{"dataType":"enum","enums":[null]}],"required":true},
        },
        "additionalProperties": false,
    },
    ...
    "ICategoryListRequest": {
        "dataType": "refObject",
        "properties": {
            "parentIds": {"dataType":"array","array":{"dataType":"string"},"required":true},
            "name": {"dataType":"string","required":true},
...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
        app.post('/api/v1/auth/sign-in',
            ...
            const args = {
                    body: {"in":"body","name":"body","required":true,"ref":"ISignInPayload"},
            };
        ...
        app.post('/api/v1/auth/sign-up',
            ...
            const args = {
                    body: {"in":"body","name":"body","required":true,"ref":"ISignUpPayload"},
            };
        ...
        app.post('/v1/category/create',
            ...
            const args = {
                    body: {"in":"body","name":"body","required":true,"ref":"ICreateCategoryRequest"},
            };
        ...
        app.post('/v1/category/list',
            ...
            const args = {
                    body: {"in":"body","name":"body","required":true,"ref":"ICategoryListRequest"},
            };
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.post('/v1/product/query',

            function ProductController_create(request: any, response: any, next: any) {
            const args = {
                    body: {"in":"body","name":"body","required":true,"ref":"IProductQueryRequest"},
            };
