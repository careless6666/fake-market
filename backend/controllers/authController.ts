...
import {
  ISignInPayload,
  ISignUpPayload,
} from "../model/http/requests/authRequests";
...
const TokenKey =
  "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCGJS+6HbYvOCR8186CXHHqlg9o/Txhlo0dsAfHDw258wAKSuuOELsCCUyPakWKStKzF5D/NGtl7VpvfAG/7s9oBAlaXyO//s4SznsttaanmvGLDj1kuJpqEi/J55GzWGprPXQrWCmUDGxE+pDci6yMdqSjVJh0Xq+HKzCven4YuwIDAQAB";

@Route("api/v1/auth/")
export class AuthController {
  @Post("/sign-in")
  public async signIn(
    @Body() body: ISignInPayload
    ...
    try {
      ...
      if (
        userInfo &&
        (await bcrypt.compare(body.password, userInfo?.password ?? ""))
      ) {
